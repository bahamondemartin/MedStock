    ...
    <div className="space-y-5">
      ...
      {!data?.family ? (
        <div className="space-y-4">
          ...
          <Card className="p-5">
            <h2 className="font-semibold text-slate-900 mb-1">Unirse a una familia</h2>
            <p className="text-sm text-slate-500 mb-4">
              Ingresa el código de 6 letras que te compartió el admin.
            </p>
            <form onSubmit={joinFamily} className="flex gap-2">
              <input
                ...
                maxLength={6}
                className="flex-1 px-3 py-2 rounded-lg border border-slate-200 text-sm font-mono tracking-widest uppercase focus:outline-none focus:ring-2 focus:ring-brand-500"
              />
              <Button type="submit" loading={joining} size="sm">
                Unirse
              </Button>
            </form>
          </Card>
